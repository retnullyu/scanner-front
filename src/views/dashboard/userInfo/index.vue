      ...
      <el-card class="box-card">
        ...
        <div class="basic-info">
          <el-tabs v-model="activeName">
            ...
            <el-tab-pane label="fofa配置" name="third">
              <el-form
                ref="fofaconfig"
                :model="fofaconfig"
                label-width="80px"
              >
                <el-form-item label="邮箱">
                  <el-input
                    v-model="fofaconfig.email"
                    clearable
                  />
                </el-form-item>
                <el-form-item label="token">
                  <el-input
                    v-model="fofaconfig.token"
                    clearable
                  />
                </el-form-item>
                <el-form-item>
                  <el-button type="primary" @click="updateFofaConfig"
                    >立即修改</el-button
                  >
                </el-form-item>
              </el-form>
...
import {saveConfig} from '@/api/fofa'
import {
  validateEmail,
  validatePassword,
  validateUsername,
...
export default {
  ...
  mounted() {
    this.entity = {
      ...
      avatar: process.env.VUE_APP_BASE_API+"/"+this.userinfo.avatar, // 头像
  ...
  methods: {
    ...
    updateFofaConfig(){
         saveConfig(this.fofaconfig).then((result)=>{
            console.log("fofa更新",result)
          })
    },
    getAvatar(data) {
      // 获取上传头像的值
